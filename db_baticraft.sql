...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Feb 2024 pada 07.56
...
CREATE TABLE `produk` (
  ...
  `jenis_lengan` enum('Panjang','Pendek') DEFAULT NULL,
  `jenis_kerah` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `transaksi` (
  ...
  `jenis_transaksi` enum('pesan','langsung') DEFAULT NULL,
  `total_item` int(3) DEFAULT NULL,
  `total_harga` int(5) DEFAULT NULL,
  `metode_pembayaran` char(1) DEFAULT NULL,
  `catatan` varchar(100) DEFAULT NULL,
  `status_transaksi` enum('dikemas','dikirim','selesai') DEFAULT NULL,
...
(1, 'Tria Yunita', '+62895342743004', 'Kabupaten Nganjuk, Jawa Timur', 'perempuan', 'Nganjuk', '2003-06-04', 'admin', 'triaynta@gmail.com', NULL, '$2y$10$.83yqJNTqEmE.i93jM5d3egMCPHdcT.bmYSzpHl/Ccwa5UUPZiW4q', NULL, '2024-02-17 11:29:59', '2024-02-17 11:29:59', NULL);
