        ...
        <section class="container py-5 mt-5 mb-lg-3">
            <div class="row align-items-center mt-md-2">
                ...
                <div class="col-lg-5 order-lg-1 pe-lg-0">
                    <h1 class="display-5 mb-4 me-lg-n5 text-lg-start text-center mb-4">Ragam Jenis <span class="dropdown d-inline-block"><a class="dropdown-toggle text-decoration-none" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Batik</a></h1>
                    <p class="text-lg-start text-center mb-4 mb-lg-5 fs-lg">Dengan motif khas, yang diproduksi secara homemade oleh <strong>Griya Sri Siji Nganjuk</strong>.</p>
                    <!-- Search form-->
                    <div class="me-lg-n5">
