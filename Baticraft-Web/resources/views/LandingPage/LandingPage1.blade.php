...
<!-- Mirrored from finder.createx.studio/city-guide-home-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 19:21:17 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/admin/images/favicon.ico') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/admin/images/favicon.ico') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/admin/images/favicon.ico') }}">
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('assets/customer/vendor/flatpickr/dist/flatpickr.min.css') }}" />
...
<body>
    ...
    <main class="page-wrapper">
        ...
        <section class="container py-5 mt-5 mb-lg-3">
            <div class="row align-items-center mt-md-2">
                <div class="col-lg-7 order-lg-2 mb-lg-0 mb-4 pb-2 pb-lg-0"><img class="d-block mx-auto" src="{{ asset('assets/customer/images/hero.png') }}" width="746" alt="Hero image"></div>
                <div class="col-lg-5 order-lg-1 pe-lg-0">
                    <h1 class="display-5 mb-4 me-lg-n5 text-lg-start text-center mb-4">Griya Batik Sri Siji <span class="dropdown d-inline-block"><a class="dropdown-toggle text-decoration-none" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nganjuk</a></h1>
                    <p class="text-lg-start text-center mb-4 mb-lg-5 fs-lg">Pusat Souvenir dan Home Industri Batik Khas Nganjuk.</p>
                    <!-- Search form-->
                    <div class="me-lg-n5">
                        <form class="form-group d-block d-md-flex position-relative rounded-md-pill me-lg-n5">
                            <div class="input-group input-group-lg border-end-md"><span class="input-group-text text-muted rounded-pill ps-3"><i class="fi-search"></i></span>
                                <input class="form-control" type="text" placeholder="Temukan batik favoritmu!">
                            </div>
                            <hr class="d-md-none my-2">
                            <div class="d-sm-flex">
                                <div class="dropdown w-100 mb-sm-0 mb-3" data-bs-toggle="select">
                                    <button class="btn btn-link btn-lg dropdown-toggle ps-2 ps-sm-3" type="button" data-bs-toggle="dropdown"><i class="fi-list me-2"></i><span class="dropdown-toggle-label">Kategori Produk</span></button>
                                    <input type="hidden">
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"><i class="fi-shopping-bag fs-lg opacity-60 me-2"></i><span class="dropdown-item-label">Kain Batik</span></a></li>
                                        <li><a class="dropdown-item" href="#"><i class="fi-shopping-bag fs-lg opacity-60 me-2"></i><span class="dropdown-item-label">Kemeja Batik</span></a></li>
                                        <li><a class="dropdown-item" href="#"><i class="fi-shopping-bag fs-lg opacity-60 me-2"></i><span class="dropdown-item-label">Kaos Batik</span></a></li>
                                    </ul>
                                </div>
                                <button class="btn btn-primary btn-lg rounded-pill w-100 w-md-auto ms-sm-3" type="button"></button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="container d-flex flex-wrap flex-column flex-sm-row pb-5 mb-md-3"><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="city-guide-catalog.html">
                <div class="icon-box-media bg-faded-accent text-accent rounded-circle me-2"><i class="fi-shopping-bag"></i></div>
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Batik Sarimbitan</h3>
            </a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="city-guide-catalog.html">
                <div class="icon-box-media bg-faded-warning text-warning rounded-circle me-2"><i class="fi-shopping-bag"></i></div>
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Batik Sasirangan</h3>
            </a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="city-guide-catalog.html">
                <div class="icon-box-media bg-faded-primary text-primary rounded-circle me-2"><i class="fi-shopping-bag"></i></div>
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Batik Jumputan</h3>
            </a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="city-guide-catalog.html">
                <div class="icon-box-media bg-faded-success text-success rounded-circle me-2"><i class="fi-shopping-bag"></i></div>
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Batik Cap</h3>
            </a><a class="icon-box card flex-row align-items-center flex-shrink-0 card-hover border-0 shadow-sm rounded-pill py-2 ps-2 pe-4 mb-2 mb-sm-3 me-sm-3 me-xxl-4" href="city-guide-catalog.html">
                <div class="icon-box-media bg-faded-primary text-primary rounded-circle me-2"><i class="fi-shopping-bag"></i></div>
                <h3 class="icon-box-title fs-sm ps-1 pe-2 mb-0">Batik Tulis</h3>
            </a>
        ...
        <section class="container mb-sm-5 mb-4 pb-lg-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
                <h2 class="h3 mb-sm-0">Produk Terbaruk</h2><a class="btn btn-link fw-normal ms-sm-3 p-0" href="city-guide-catalog.html">View all<i class="fi-arrow-long-right ms-2"></i></a>
            </div>
            <div class="tns-carousel-wrapper tns-controls-outside-xxl tns-nav-outside">
                <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 3, &quot;gutter&quot;: 24, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1,&quot;nav&quot;:true},&quot;500&quot;:{&quot;items&quot;:2},&quot;850&quot;:{&quot;items&quot;:3},&quot;1400&quot;:{&quot;items&quot;:3,&quot;nav&quot;:false}}}">
                    ...
                    <div>
                        <div class="position-relative">
                            <div class="position-relative mb-3">
                                <button class="btn btn-icon btn-light-primary btn-xs text-primary rounded-circle position-absolute top-0 end-0 m-3 zindex-5" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title=""><i class="fi-heart"></i></button><img class="rounded-3" src="{{ asset('assets/customer/images/catalog-1.jpg') }}" alt="Image">
                            </div>
                    ...
                    <div>
                        <div class="position-relative">
                            <div class="position-relative mb-3">
                                <button class="btn btn-icon btn-light-primary btn-xs text-primary rounded-circle position-absolute top-0 end-0 m-3 zindex-5" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title=""><i class="fi-heart"></i></button><img class="rounded-3" src="{{ asset('assets/customer/images/catalog-2.jpg') }}" alt="Image">
                            </div>
                    ...
                    <div>
                        <div class="position-relative">
                            <div class="position-relative mb-3">
                                <button class="btn btn-icon btn-light-primary btn-xs text-primary rounded-circle position-absolute top-0 end-0 m-3 zindex-5" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title=""><i class="fi-heart"></i></button><img class="rounded-3" src="{{ asset('assets/customer/images/catalog-3.jpg') }}" alt="Image">
                            </div>
                    ...
                    <div>
                        <div class="position-relative">
                            <div class="position-relative mb-3">
                                <button class="btn btn-icon btn-light-primary btn-xs text-primary rounded-circle position-absolute top-0 end-0 m-3 zindex-5" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title=""><i class="fi-heart"></i></button><img class="rounded-3" src="{{ asset('assets/customer/images/catalog-4.jpg') }}" alt="Image">
                            </div>
        ...
        <section class="container mb-5 pb-lg-3">
            <div class="d-md-flex align-items-center justify-content-between mb-4 pb-md-2">
                <h2 class="h3 w-100 mb-md-0">Custome Motif Batik </h2>
                <!-- Sorting by date-->
    ...
    <script src="{{ asset('assets/customer/vendor/flatpickr/dist/flatpickr.min.js') }}"></script>
    <!-- Main theme script-->
    <script src="{{ asset('assets/customer/js/theme.min.js') }}"></script>
</body>

<!-- Mirrored from finder.createx.studio/city-guide-home-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 19:21:35 GMT -->
