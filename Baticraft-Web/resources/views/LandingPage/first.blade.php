...
<!-- Mirrored from finder.createx.studio/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 19:19:51 GMT -->
    ...
    <main class="page-wrapper">
        ...
        <div class="container"><a class="navbar-brand me-2 me-xl-4" href="#">Baticraft</a>
          ...
          <div class="collapse navbar-collapse order-md-2" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link" href="components/typography.html">Tentang Kami</a></li>
              <li class="nav-item"><a class="nav-link" href="docs/dev-setup.html">Kontak</a></li>
            </ul>
          </div>
        </div>
      </header>
      ...
      <section class="position-relative overflow-hidden py-5 mb-5">
        ...
        <div class="container content-overlay mt-4 mb-2 mt-lg-5 mb-lg-4 pt-5 pb-md-2">
          <h1 class="display-4 text-center text-md-start">Batik Home Made Berkualitas</h1>
          <div class="row">
...
<!-- Mirrored from finder.createx.studio/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 19:19:56 GMT -->
</html>