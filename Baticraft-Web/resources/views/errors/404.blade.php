            ...
            <div class="row min-vh-100 justify-content-center align-items-center">
                ...
                <div class="offset-lg-1 col-lg-10  py-8 py-xl-0">
                    <div class=" mb-10 mb-xxl-0">
                        <!-- img -->
                        <a href=""> <img src="{{ asset('assets/admin/images/logo.png') }}" alt=""></a>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <!-- content -->
                        <div class="col-md-6">
                            <div class=" mb-6 mb-lg-0">
                                <h1>Ada yang salah di sini...</h1>
                                <p class="mb-8">Kami tidak dapat menemukan halaman yang Anda cari. 
                                    <br> Kunjungi pusat bantuan kami atau kembali ke home.</p>
                                <!-- btn -->
                                <a href="#" class="btn btn-dark">Pusat Bantuan <i class="feather-icon icon-arrow-right"></i></a>
                                <!-- btn -->
                                <a href="{{ route('home') }}" class="btn btn-primary ms-2">Home</a>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                <!-- img -->
                                <img src="{{ asset('assets/customer/images/svg-graphics/error.svg') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
