                    ...
                    <div class="col">
                        <div class="card card-product">
                            <div class="card-body">
                                ...
                                <div class="text-center position-relative "><img src="{{ asset('storage/user/' . auth()->user()->image) }}" class="rounded-circle avatar-lg img-thumbnail" style="width: 150px; height: 150px; transform: scale(1.5);"></div>
