...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('assets/customer/vendor/leaflet/dist/leaflet.css') }}" />
    <link rel="stylesheet" media="screen" href="{{ asset('assets/customer/vendor/lightgallery.js/dist/css/lightgallery.min.html') }}" />
...
<body>
            ...
            <div class="bg-dark rounded-3">
                <div class="col-xxl-10 col-md-11 col-10 d-flex flex-md-row flex-column-reverse align-items-md-end align-items-center mx-auto px-0"><img class="flex-shrink-0 mt-md-n5 me-md-5" src="img/real-estate/illustrations/mobile.svg" width="240" alt="Finder mobile app">
                    <div class="align-self-center d-flex flex-lg-row flex-column align-items-lg-center pt-md-3 pt-5 ps-xxl-4 text-md-start text-center">
                        ...
                        <div class="flex-shrink-0"><a class="btn-market mx-2 ms-sm-0 me-sm-4 mb-3" href="#" role="button"><svg xmlns='http://www.w3.org/2000/svg' width='132' height='34' fill='#fff'>
    ...
    <script src="{{ asset('assets/customer/vendor/leaflet/dist/leaflet.js') }}"></script>
    <script src="{{ asset('assets/customer/vendor/lightgallery.js/dist/js/lightgallery.min.html') }}"></script>
    <script src="{{ asset('assets/customer/vendor/lg-fullscreen.js/dist/lg-fullscreen.min.html') }}"></script>
    <script src="{{ asset('assets/customer/vendor/lg-zoom.js/dist/lg-zoom.min.html') }}"></script>
    <script src="{{ asset('assets/customer/vendor/lg-thumbnail.js/dist/lg-thumbnail.min.html') }}"></script>
...
<!-- Mirrored from finder.createx.studio/real-estate-home-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 19:20:49 GMT -->
