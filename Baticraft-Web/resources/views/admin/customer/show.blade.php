        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="index">Customer</a></li>
                    <li class="breadcrumb-item active">Lihat Customer</li>
                </ol>
            </div>
            <h4 class="page-title">Lihat Customer</h4>
        </div>
    </div>
</div>
<!-- end page title -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title"><center>Data Customer</center></h4>
